    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="flex items-center space-x-4 mt-2">
              ...
              <span className="text-gray-500 text-sm">{platform.category || 'Uncategorized'}</span>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          {platform.featuresJson && (
            <Card className="p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Features</h2>
              <pre className="bg-gray-100 p-4 rounded-lg overflow-x-auto text-sm">
                {JSON.stringify(platform.featuresJson, null, 2)}
              </pre>
            </Card>
          )}
        </div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <Link to={`/deploy?platformId=${id}`} className="block">
                <Button className="w-full">Deploy Function</Button>
              </Link>
